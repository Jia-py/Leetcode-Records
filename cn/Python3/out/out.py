import sys
import json
sys.path.append("D:\\My_Documents\\study\\leetcode\\cn\\Python3")
sys.path.append("D:\\My_Documents\\study\\leetcode")
a = __import__('121_买卖股票的最佳时机')
class TreeNode:
...
arr=json.loads("[[[7,1,5,3,6,4]],[[7,6,4,3,1]]]")
for i in range(len(arr)):
    unitArgs=arr[i]
    s=a.Solution()
    arg0 = unitArgs[0]
    result=s.maxProfit(arg0)
